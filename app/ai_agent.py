...
class AIAgent:
    ...
    def _template_smart_scan_report(self, results: list, total: int,
        ...
        lines.extend([
            "\n━━━━━━━━━━━━━━━━━━━━━━━━",
            f"\n{rec}",
            "\n🤖 تم إعداد هذا التقرير بواسطة **المحلل الذكي** | **ميزان كوانت** (mizanquant)",
    ...
    def _template_answer(self, question: str, context: dict) -> str:
        ...
        if any(w in q for w in ["السلام", "مرحبا", "hello", "hi", "مرحباً"]):
            return (
                ...
                "أنا **المحلل الذكي** لمنصة **ميزان كوانت** (mizanquant) — تداول خوارزمي وفق الشريعة. يمكنني مساعدتك في:\n"
