...
const AI_QUICK = [
  { label: "🚀 مرشّحو الصعود القريب", q:
    ...
    "1) اجلب المرشّحين الحلال من الماسحَين معاً: get_deep_picks (الشهري المركّب) و get_buy_signals (الأسبوعي swing) — وادمج القائمتين وميّز مصدر كل سهم (شهري/أسبوعي). لا تكتفِ بأحدهما.\n" +
  ...
  { label: "🔍 Upside candidates", q:
    ...
    "1) Pull halal candidates from BOTH scanners: get_deep_picks (Monthly composite) AND get_buy_signals (Weekly swing) — merge the two lists and tag each name's source (monthly/weekly). Don't use just one.\n" +
  ...
  { label: "Best halal picks", q: "What are the best halal opportunities today across BOTH scanners — Weekly (get_buy_signals) and Monthly (get_deep_picks)? Merge and tag the source, then analyze the strongest. Reply in English." },
