...
const AI_QUICK = [
  { label: "🔍 الأسهم المرشّحة للصعود", q:
    ...
    "3) رتّبها حسب احتمال الصعود القريب، واستبعد أو نبّه على: أرباح خلال نافذة الحظر، بيع مطّلعين كثيف (heavy_sell)، أو ميل محلّلين بيعي (bearish).\n" +
    "4) اعرض جدولاً: السهم | السكور | الإشارة | السبب المختصر (من البيانات) | التحذيرات. ثم أفضل 3 مع نقاط دخول/وقف/هدف.\n" +
    "اعتمد فقط ما تؤكّده الأدوات؛ وقل 'غير متاح' لأي بيانات مفقودة (known=false) ولا تختلقها." },
